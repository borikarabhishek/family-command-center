...
export const demoAssets: Asset[] = [
  ...
  {
    id: "ast_5",
    name: "Term & ULIP cover (surrender value)",
    category: "Insurance",
    value: 620_000,
    ownerId: "mem_1",
  },
...
export const demoLiabilities: Liability[] = [
  {
    id: "lia_1",
    name: "Home loan — Baner apartment",
    category: "Home loan",
    outstanding: 6_850_000,
    monthlyObligation: 62_400,
    ownerId: "mem_1",
  ...
  },
  {
    ...
    outstanding: 96_000,
    monthlyObligation: 12_000,
    ownerId: "mem_2",
  },
  {
    id: "lia_4",
    name: "Education loan (planned drawdown)",
    category: "Education loan",
    outstanding: 350_000,
    monthlyObligation: 8_500,
    ownerId: "mem_3",
  },
];
...
export const demoDocuments: FamilyDocument[] = [
  ...
  {
    id: "doc_5",
    name: "Term life policy — Abhishek",
    category: "Insurance",
    ownerId: "mem_1",
    uploadedAt: "2026-04-02",
  ...
  {
    id: "doc_6",
    name: "Sale deed — Baner apartment",
    category: "Property",
    ownerId: "mem_1",
  ...
  {
    id: "doc_7",
    name: "Home loan agreement — ICICI",
    category: "Legal",
    ownerId: "mem_1",
    uploadedAt: "2026-04-10",
  ...
  {
    id: "doc_8",
    name: "Registered will — Sushila Rao",
    category: "Legal",
    ownerId: "mem_5",
  ...
  {
    id: "doc_9",
    name: "ITR acknowledgement FY 2024-25",
    category: "Tax",
    ownerId: "mem_1",
  ...
  {
    id: "doc_10",
    name: "School fee receipts — Vihaan",
    category: "Education",
    ownerId: "mem_3",
  ...
  {
    id: "doc_18",
    name: "Mutual fund consolidated statement",
    category: "Financial",
    ownerId: "mem_1",
  ...
  {
    id: "doc_20",
    name: "Property tax receipt — Pune",
    category: "Tax",
    ownerId: "mem_1",
  ...
  {
    id: "doc_24",
    name: "School admission letter — Ira",
    category: "Education",
    ownerId: "mem_4",
...
export const demoTasks: FamilyTask[] = [
  {
    id: "tsk_1",
    title: "Renew family health insurance",
    ownerId: "mem_1",
    assigneeId: "mem_2",
    priority: "High",
    dueDate: "2026-09-12",
  ...
  {
    id: "tsk_2",
    title: "Pay Q2 school fee — Vihaan",
    ownerId: "mem_2",
    assigneeId: "mem_2",
    priority: "High",
    dueDate: "2026-09-05",
  ...
  {
    id: "tsk_4",
    title: "Review Nagpur rental agreement",
    ownerId: "mem_1",
    assigneeId: "mem_5",
    priority: "High",
    dueDate: "2026-08-31",
  ...
  {
    id: "tsk_5",
    title: "File advance tax instalment",
    ownerId: "mem_1",
    assigneeId: "mem_1",
    priority: "Medium",
    dueDate: "2026-09-15",
  ...
  {
    id: "tsk_6",
    title: "Schedule mother's annual health check",
    ownerId: "mem_1",
    assigneeId: "mem_2",
    priority: "Medium",
    dueDate: "2026-09-20",
  ...
  {
    id: "tsk_7",
    title: "Digitise property papers — Baner",
    ownerId: "mem_1",
    assigneeId: "mem_1",
    priority: "Low",
    dueDate: "2026-10-10",
  ...
  {
    id: "tsk_8",
    title: "Update nominee details across accounts",
    ownerId: "mem_1",
    assigneeId: "mem_2",
    priority: "Medium",
    dueDate: "2026-10-01",
...
export const demoProfessionals: Professional[] = [
  {
    ...
    indicativeFee: "₹3,500 / consultation",
  },
  {
    id: "pro_2",
    name: "CA Rohit Deshpande",
    profession: "CA / Tax",
    specialization: "Personal & LLP taxation",
    experienceYears: 11,
    location: "Pune",
    rating: 4.7,
    availability: "Within 3 days",
    indicativeFee: "₹2,500 / consultation",
  },
  {
    id: "pro_3",
    name: "Nandini Iyer, CFP",
    profession: "Financial Planning",
    specialization: "Family cashflow planning",
    experienceYears: 9,
    location: "Mumbai (remote)",
    rating: 4.6,
    availability: "Next week",
    indicativeFee: "₹5,000 / plan review",
  },
  {
    id: "pro_4",
    name: "Sameer Khan",
    profession: "Insurance",
    specialization: "Health & term cover",
    experienceYears: 12,
    location: "Pune",
    rating: 4.5,
    availability: "Same day",
    indicativeFee: "No consultation fee",
  },
];
...
export const demoServiceRequests: ServiceRequest[] = [
  {
    id: "req_1",
    category: "Legal",
    summary: "Review ancestral property title and will",
    memberId: "mem_5",
    urgency: "High",
  ...
  },
  {
    id: "req_2",
    category: "Insurance",
    summary: "Compare health cover renewal options",
    memberId: "mem_1",
    urgency: "Medium",
  ...
  },
  {
    id: "req_3",
    category: "CA / Tax",
    summary: "Advance tax computation FY 2026-27",
    memberId: "mem_1",
    urgency: "Medium",
...
export const demoEvents: CalendarEvent[] = [
  ...
  {
    id: "evt_2",
    title: "School fee deadline — Vihaan",
    date: "2026-09-05",
    type: "Deadline",
    memberId: "mem_3",
  },
  {
    id: "evt_3",
    title: "Passport renewal window opens",
    date: "2026-08-30",
    type: "Deadline",
    memberId: "mem_2",
  },
  ...
  {
    id: "evt_5",
    title: "Property document review with lawyer",
    date: "2026-08-28",
    type: "Appointment",
    memberId: "mem_5",
  },
...
export const demoConversations: Conversation[] = [
  {
    id: "con_1",
    title: "Family",
    participant: "Sneha, Sushila",
    lastMessage: "Shared the school fee receipt in the vault.",
    lastAt: "2026-08-23",
    unread: 2,
  },
  {
    id: "con_2",
    title: "Adv. Meera Kulkarni",
    participant: "Legal Advisor",
    lastMessage: "Please authorise access to the sale deed.",
    lastAt: "2026-08-23",
    unread: 1,
  },
  {
    id: "con_3",
    title: "CA Rohit Deshpande",
    participant: "CA",
    lastMessage: "Advance tax working attached.",
    lastAt: "2026-08-21",
    unread: 0,
  },
  {
    id: "con_4",
    title: "FamilyOS Support",
    participant: "Support",
    lastMessage: "Your family workspace is ready.",
    lastAt: "2026-08-19",
    unread: 0,
  },
];
